...
def main():
    ...
    if args.local_rank == 0:
        ...
        dump_input = torch.rand(
            (1, 4, config.TRAIN.IMAGE_SIZE[1], config.TRAIN.IMAGE_SIZE[0])
            )
    ...
    for epoch in range(last_epoch, end_epoch):
        ...
        valid_loss, valid_loss_joints, valid_loss_inp, valid_acc = validate(config, testloader, model, writer_dict, device)
        ...
        if args.local_rank == 0:
            ...
            msg = 'Loss: {:.6f}, {:.6f}, {:.6f}, Accuracy: {:.6f}'.format(valid_loss, valid_loss_joints, valid_loss_inp, valid_acc)
